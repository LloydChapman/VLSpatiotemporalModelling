...
DICminMdl=RunCalcParEstsAndDICdiffs2(rslts,np,burnin,IPD,str,true,true,true,runName);
...
SaveSamplesAsCSVs(rslts{DICminMdl},nsmpls1,burnin,rslts{DICminMdl}(19:end))